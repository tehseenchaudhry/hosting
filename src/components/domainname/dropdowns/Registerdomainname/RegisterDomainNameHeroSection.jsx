...
const RegisterDomainNameHeroSection = () => {
    ...
    return (
        <section className="relative bg-[#020b3a] h-[90vh] p-6 mb-28">
            ...
            <div className="max-w-7xl mx-auto px-6 py-4 text-sm text-white flex items-center gap-2">
                ...
                <span>/</span>
                <span className="text-gray-300">Register Domain name</span>
            </div>
            ...
            <div className=" top-50 max-w-7xl mx-auto px-6 mt-8 ">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(https://www.genious.net/themes/genious_theme/img/solutions-mail/slider-microsoft.webp)"
                    }}
                >
                    {/* Overlay Card */}
                    <div className="absolute left-8 top-1/2 -translate-y-1/2 bg-black/60 text-white p-8 rounded-lg max-w-md">
                        <h1 className="text-5xl font-bold mb-4">Register your domain name!</h1>
...
export default RegisterDomainNameHeroSection