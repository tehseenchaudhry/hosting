...
const HostingHeroSectionModal = ({ 
  ...
  // Reset selected extensions when modal opens
  useEffect(() => {
    if (isOpen) {
      setSelectedExtensions([]);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-start justify-center p-4 overflow-y-auto backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden my-8 animate-fadeIn">
        {/* Modal Header */}
...
export default HostingHeroSectionModal;